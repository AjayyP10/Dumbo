      ...
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 pr-12">
          ...
          <p className="text-xl text-indigo-100/80 max-w-lg leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Create your account to save your progress, access history across devices, and unlock personalized features.
          </p>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="hidden lg:block mb-8">
              ...
              <p className="text-indigo-200 mt-2">Start your language learning journey</p>
            </div>
