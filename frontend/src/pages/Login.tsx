  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-gray-900 flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-indigo-600/30 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: "8s" }}></div>
        <div className="absolute top-1/2 right-0 w-[600px] h-[600px] bg-purple-600/20 rounded-full blur-[120px] animate-pulse" style={{ animationDuration: "10s", animationDelay: "1s" }}></div>
        <div className="absolute -bottom-20 left-1/3 w-[400px] h-[400px] bg-pink-600/20 rounded-full blur-[80px] animate-pulse" style={{ animationDuration: "6s", animationDelay: "2s" }}></div>
      </div>
      ...
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 pr-12">
          <div className="flex items-center space-x-4 mb-4 animate-fade-in">
            <img src="/icons/dumbo_logo.svg" alt="Dumbo Logo" className="w-16 h-16 drop-shadow-lg" />
            <h1 className="text-6xl font-black text-white tracking-tight">
              Dumbo
            </h1>
          </div>

          <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-200 to-purple-200 leading-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Master languages with <br /> precise CEFR-level translations.
          </h2>

          <p className="text-xl text-indigo-100/80 max-w-lg leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Your personal AI-powered translator that adapts to your proficiency level. Learn faster with context-aware translations.
          </p>
          ...
          <div className="grid gap-6 mt-8">
            {[
              ...
              <div key={idx} className="flex items-center space-x-4 bg-white/5 backdrop-blur-sm p-4 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors animate-fade-in" style={{ animationDelay: `${0.3 + idx * 0.1}s` }}>
                <div className={`w-12 h-12 ${feature.color} rounded-xl flex items-center justify-center shadow-lg shrink-0`}>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10 animate-fade-in" style={{ animationDelay: "0.4s" }}>

            {/* Mobile Logo View */}
            <div className="lg:hidden flex flex-col items-center mb-8">
              <img src="/icons/dumbo_logo.svg" alt="Dumbo Logo" className="w-16 h-16 mb-4 drop-shadow-lg" />
              <h1 className="text-3xl font-black text-white">Dumbo</h1>
              <p className="text-indigo-200 text-center mt-2">Sign in to continue your journey</p>
            </div>

            <div className="hidden lg:block mb-8">
              <h2 className="text-3xl font-bold text-white">Welcome back</h2>
              <p className="text-indigo-200 mt-2">Enter your details to access your account</p>
            </div>

            <form onSubmit={onSubmit} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-indigo-100 mb-2" htmlFor="username">
                  Username or Email
                </label>
                <input
                  id="username"
